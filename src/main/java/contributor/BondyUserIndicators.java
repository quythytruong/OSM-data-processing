...
public class BondyUserIndicators {
	public static void main(String[] args) throws Exception {
		...
		Double[] bbox = loader.getCityBoundary("Fougères", "2018-02-13T23:59:59Z");
		...
		// Make a summary of the contributors in Bretagne
		...
		SocialGraph.writeGraph2CSV(coeditg, new File("Bretagne/fougeres-coedit_graph_2000-20180212.csv"), (long) 0);
		...
		SocialGraph.writeGraph2CSV(useg, new File("Bretagne/fougeres-use_graph_2000-20180212.csv"), (long) 0);
		...
		SocialGraph.writeGraph2CSV(suppressiong, new File("Bretagne/fougeres-suppression_graph_2000-20180212.csv"),
				(long) 0);
		...
		ChangesetRetriever chgstRtv = new ChangesetRetriever("localhost", "5432", "bretagne", "postgres", "postgres");

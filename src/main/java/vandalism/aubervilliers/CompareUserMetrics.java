...
import contributor.UserMetricsPromethee;
...
public class CompareUserMetrics {
	public static void main(String[] args) throws Exception {
		...
		for (OSMContributor user : myContributors.values()) {
			...
			Double weightedAvg = (2 * pModif + 2 * pDelete + 3 * pUsed - pCoedited - pDeleted) / 9;
		...
		List<Integer> usersRangedByPromethee = rankingPromethee.compute(myContributors, coeditg, useg, suppressiong);
		...
		List<Integer> usersRangedByContributions1OutOf3 = usersRangedByContributions.subList(0, 20);
		List<Integer> usersRangedByContributions2OutOf3 = usersRangedByContributions.subList(20, 170);
		List<Integer> usersRangedByContributions3OutOf3 = usersRangedByContributions.subList(170, 189);
		...
		List<Integer> usersRangedByAvgMetrics1OutOf3 = usersRangedByAvgMetrics.subList(0, 20);
		List<Integer> usersRangedByAvgMetrics2OutOf3 = usersRangedByAvgMetrics.subList(20, 170);
		List<Integer> usersRangedByAvgMetrics3OutOf3 = usersRangedByAvgMetrics.subList(170, 189);

		// Classement par moyenne pondérée des 6 métriques
		List<Integer> usersRangedByWeightedAvgMetrics1OutOf3 = usersRangedByWeightedAvgMetrics.subList(0, 20);
		List<Integer> usersRangedByWeightedAvgMetrics2OutOf3 = usersRangedByWeightedAvgMetrics.subList(20, 170);
		List<Integer> usersRangedByWeightedAvgMetrics3OutOf3 = usersRangedByWeightedAvgMetrics.subList(170, 189);
		...
		System.out.println("Valeur M2 = " + unsortedAverageUserMetrics.get(GC1));
		...
		System.out.println("Valeur M2 = " + unsortedAverageUserMetrics.get(GC2));
		...
		System.out.println("Valeur M2 = " + unsortedAverageUserMetrics.get(MC1));
		...
		System.out.println("Valeur M2 = " + unsortedAverageUserMetrics.get(MC2));
		...
		System.out.println("Valeur M2 = " + unsortedAverageUserMetrics.get(PC1));
		...
		System.out.println("Valeur M2 = " + unsortedAverageUserMetrics.get(PC2));

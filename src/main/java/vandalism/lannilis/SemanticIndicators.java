...
public class SemanticIndicators {
	...
	public static void main(String[] args) throws Exception {
		...
		chgset.executeAnyQuery("ALTER TABLE indicators.lannilis_v ADD COLUMN max_special_char_ratio double precision;");
		// Cherche les données de bâti vandalisés
		String query = "SELECT * FROM lannilis_vandalisme;";
		...
		for (int id : specialCharRatios.keySet())
			query += "UPDATE indicators.lannilis_v SET max_special_char_ratio = " + specialCharRatios.get(id)
					+ " WHERE id = " + id + "; ";
		...
		// maxSpecialCharRatio = ratio;
		// }
		// query += "UPDATE indicators.lannilis SET max_special_char_ratio = " +

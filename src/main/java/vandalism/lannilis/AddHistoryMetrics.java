...
public class AddHistoryMetrics {
	public static void main(String[] args) throws Exception {
		...
		String select = "SELECT a.*, hstore_to_json(a.tags) FROM way a, indicators.lannilis b "
		...
		for (OSMResource r : ld.myJavaObjects) {
			...
			query.append("UPDATE indicators.lannilis SET n_versions=" + nbVersions + ", n_users=" + nbUsers + ", n_del="
			...
			query.append("UPDATE indicators.lannilis SET is_geom_edit_prev_version = " + isGeomEdit
